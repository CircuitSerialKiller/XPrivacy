...
//GID = (Security) Group ID. Android uses Linux groups for permissions
//PID = Process ID
//http://pierrchen.blogspot.com/2016/09/an-walk-through-of-android-uidgid-based.html


public class XProcess extends XHook {
	private Methods mMethod; //startViaZygote is only method available
	...
	final static int sdcard_r = 1028; // 4.1+ No 3rd party access in 6+
	final static int sdcard_rw = 1015; // 4.0+ No 3rd party access in 6+
